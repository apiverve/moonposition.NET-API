...
namespace APIVerve
{
    public class MoonPositionAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/moonposition";
        ...
        public MoonPositionAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public MoonPositionAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, MoonPositionQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(MoonPositionQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(MoonPositionQueryOptions options)
        {
